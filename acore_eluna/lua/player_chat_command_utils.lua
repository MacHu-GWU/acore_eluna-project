...
function player_chat_command_utils.PlayerChatCommandTreeGossipMenuHandler:OnSelectOption(
    ...
    print(string.format(
            "Player select: id = %s, name = %s, type = %s, icon = %s, parent = %s",
            selectedGossipOption.id,
            selectedGossipOption.name,
            selectedGossipOption.type,
            selectedGossipOption.icon,
            selectedGossipOption.parent
    ))
