...
table.find = function(menuDataMapper, menuDataValue, menuDataKey)
    --[[
    这个函数的目的是查找 key, value pair 符合条件的 metaData 的 ID.

    类似于 SELECT ID FROM table WHERE talbe.menuDataKey = menuDataValue.

    :type table: table
    :param table: 一个 {ID: menuData} 的字典, 其中 ID 是整数
    :type _tofind: number
    :param _tofind:

    :type _index: string
    :param _index: menuData 中的 key, 用于查找 menuData 中的 value
    --]]
