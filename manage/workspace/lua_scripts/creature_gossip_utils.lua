...
比如我想要绑定 NpcTreeGossipMenuHandler.OnChat 方法, 我只需要:

local boundOnChat = NpcTreeGossipMenuHandler:bindMethod("OnChat")

然后我只要想把 NpcTreeGossipMenuHandler.OnChat 方法本身当成一个参数传递给 RegisterPlayerEvent 函数时,
